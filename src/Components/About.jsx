        ...
        <>
            <div className="about flex align-middle justify-center row gap-10 bg-white text-primary-color px-10 py-5">
                ...
                <div className='flex flex-col gap-7 about__description flex-1/2 text-left py-7'>
                    ...
                    <h2 className='flex row text-2xl font-bold'><i className='bxr bx-education text-5xl text-secondary-color'></i> <h2 className='my-auto'>+3ans</h2></h2>
                    ...
                    <h2 className='flex row text-2xl font-bold'><i className='bxr  bx-people-diversity text-5xl text-secondary-color'></i> <h2 className='my-auto'>+250 étudiants</h2></h2>
                    ...
                    <h2 className='flex row text-2xl font-bold'><i className='bxr  bx-medal-star text-5xl text-secondary-color'></i> <h2 className='my-auto'>Notre mission</h2></h2>
