...
function Header() {
    return(
        <>
            <header className="flex row justify-between items-center px-7 py-5 bg-blue-950">
                ...
                <div className="links text-white">
                    <ul className="flex row gap-10 items-center ">
                        ...
                        <li className="font-bold bg-amber-400 p-3 rounded-sm"><a href="http://">INTRANET</a></li>
                    </ul>
                </div>
            </header>
        </>
